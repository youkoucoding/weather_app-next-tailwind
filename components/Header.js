...
export default function Header() {
  return (
    <div className="flex flex-col h-full overflow-hidden rounded-b-lg">
      <div className="bg-green-700 px-2 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-20">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
          <div className="flex justify-end flex-1 ml-12 sm:items-stretch">

            <a
              className="flex items-center px-4 py-2 space-x-2 rounded-md hover:bg-violet-100 group"
              href="https://github.com/youkoucoding/weather_app-next-tailwind"
              target="_blank"
              rel="noreferrer"
            >
              <svg
